<p align="center">
Adds IPython like shell execution magic.
</p>

<p align="center">  
If you like the idea click ⭐ on the repo and <a href="https://twitter.com/intent/tweet?text=Nice%20xontrib%20for%20the%20xonsh%20shell!&url=https://github.com/c6401/xontrib-ipython-shell-magic" target="_blank">tweet</a>.
</p>
...
```bash
xpip install xontrib-ipython-shell-magic
# or: xpip install -U git+https://github.com/c6401/xontrib-ipython-shell-magic
```
